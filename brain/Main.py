...
from perception.camera.pictocord import pictocord
from perception.camera.image import imagecapture
...
def main():
    ...
    #img = imagecapture(0)
    #img = cv2.imread("Bane.jpg") #For testing purposes, change to imagecapture(0) for actual use
    img = imagecapture(0)
