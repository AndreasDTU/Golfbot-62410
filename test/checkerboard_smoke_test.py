...
INPUT_IMAGE = Path("/test/images/checkerboard_test.png")
OVERLAY_OUTPUT = Path("/test/artifacts/checkerboard_overlay.png")
REPORT_OUTPUT = Path("/test/artifacts/checkerboard_report.json")
SIDE_BY_SIDE_OUTPUT = Path(
    "/test/artifacts/checkerboard_side_by_side.png"
)
